import { selectTodosView } from './todo.selectors';
import { initialState } from './todo.reducer';

describe('Todo selectors', () => {
  describe('selectTodosView', () => {
    it('returns todo view state with ALL filter', () => {
      // TODO 4: implement "selectTodos" selector test (remember that selector exposes its function in "projector" property)
      // test if result contains desired data (eg how many todos were selected based on provided state)
      ...
      // and adjust it if you want to override some property, eg { ...initialState, todoFilter: 'DONE' }
    });
